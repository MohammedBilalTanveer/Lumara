...
export const Home = ({ onPageChange }) => {
  ...
  // Optimized variants: Shorter durations, simpler easing, conditional reduction
  const fadeUp = {
  ...
  const heroImageVariants = shouldReduceMotion
    ? { hidden: { opacity: 0 }, show: { opacity: 1, transition: { duration: 0.3 } } }
    : {
    ...
    <div className="space-y-28 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  variant="secondary"
                  className="group hover:scale-105 transition-all duration-200" // Shorter duration
                ...
                <Button
                  ...
                  onClick={() => onPageChange("venturestudio")}
                >
                Venture Studio
                </Button>
              </div>
            ...
            >
              <ImageWithFallback
                ...
                className="rounded-3xl shadow-2xl w-full h-[450px] object-cover" // Removed hover scale to avoid reflows
      ...
      <section ref={statsRef} className="container mx-auto px-4">
        <motion.div
          ...
          variants={{
            hidden: {},
            show: { transition: { staggerChildren: 0.1 } }, // Reduced stagger for faster load
          }}
        >
          {stats.map((stat, i) => (
            <motion.div key={i} variants={fadeUp}>
              <Card className="text-center rounded-3xl shadow-lg hover:shadow-primary/50 transition-all duration-200 bg-gradient-to-br from-primary to-primary/80 border-none text-white"> {/* Shorter transition */}
                  ...
                  <div className="text-5xl font-bold mb-2 text-white">
                    {statsInView ? (
                      <CountUp
                        ...
                        duration={shouldReduceMotion ? 0.5 : 1.5} // Shorter duration if reduced motion
                        suffix={stat.suffix}
                        separator=","
                      />
                    ) : (
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <ImageWithFallback
              ...
              className="rounded-3xl w-full h-[450px] object-cover shadow-xl" // Removed hover scale
              loading="lazy"
            />
          </motion.div>
      ...
      <section className="container mx-auto px-4">
        ...
        <motion.div
          ...
          variants={{
            hidden: {},
            show: { transition: { staggerChildren: 0.05 } }, // Minimal stagger
          }}
        >
          {[
            {
            ...
            <motion.div key={i} variants={fadeUp}>
              <Card
                className={`min-h-[200px] transition-transform duration-200 hover:scale-[1.01] rounded-3xl shadow-md bg-gradient-to-br ${focus.gradient} border`} // Minimal scale, short duration
              >
                <CardHeader>
...
<section className="bg-muted/50 py-24">
  <div className="container mx-auto px-4">
    ...
    <motion.div
      ...
      variants={{
        hidden: {},
        show: { transition: { staggerChildren: 0.1 } }, // Reduced stagger
      }}
    >
      {[
        {
        ...
        <motion.div key={i} variants={fadeUp}>
          <Card
            className={`transition-all duration-200 hover:shadow-xl bg-gradient-to-br ${company.color} rounded-3xl border h-full flex flex-col justify-between`} // Reduced shadow intensity, shorter duration
          >
            <CardHeader>
          ...
          <CardContent className="text-center py-20 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                variant="secondary"
                className="px-8 transition-transform duration-200 hover:scale-105"
              ...
              <Button
                size="lg"
                variant="outline"
                className="bg-transparent border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary transition-transform duration-200 hover:scale-105"
                onClick={() => {
